...
def interface():
	...
	while continuer_interface:
		...
		Map.blit(coins,(x_coins,y_coins))#25,820
		Map.blit(affiche_nb_coins,(x_coins+145,y_coins+50))#170,870
...
while continuer:
	...
	affiche6 = arial4.render("Coins x "+str(nb_coins),True,white)
