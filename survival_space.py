...
vaisseau_anim = pygame.transform.scale(pygame.image.load("C:\\Users\\michael\\Pictures\\vaisseau_anim.png"),(taille_x_vaisseau,taille_y_vaisseau))
vaisseau_anim1 = pygame.transform.scale(pygame.image.load("C:\\Users\\michael\\Pictures\\vaisseau_anim1.png"),(taille_x_vaisseau,taille_y_vaisseau))
vaisseau_anim2 = pygame.transform.scale(pygame.image.load("C:\\Users\\michael\\Pictures\\vaisseau_anim2.png"),(taille_x_vaisseau,taille_y_vaisseau))
vaisseau_anim3 = pygame.transform.scale(pygame.image.load("C:\\Users\\michael\\Pictures\\vaisseau_anim3.png"),(taille_x_vaisseau,taille_y_vaisseau))
vaisseau_anim4 = pygame.transform.scale(pygame.image.load("C:\\Users\\michael\\Pictures\\vaisseau_anim4.png"),(taille_x_vaisseau,taille_y_vaisseau))
vaisseau_anim5 = pygame.transform.scale(pygame.image.load("C:\\Users\\michael\\Pictures\\vaisseau_anim5.png"),(taille_x_vaisseau,taille_y_vaisseau))
